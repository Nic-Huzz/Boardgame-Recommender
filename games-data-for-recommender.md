# Board Game Recommender — New Games Data

This document contains game data formatted for integration into the Board Game Recommender.
Each game includes BGG ID, metadata, and element decomposition.

---

## How to Use This Document

Feed this to Claude CLI with instructions like:
"Add these games to the GAMES array in board-game-recommender-v7.jsx following the existing data structure format."
...
```javascript
{
  ...
  traits: ['cooperative', 'beautiful', 'communication-limits', 'social-deduction', 'thematic'],
  elements: [
    { id: 'mysterium-coop', label: 'All players work together to solve the murder', traits: ['cooperative', 'social'] },
    { id: 'mysterium-art', label: 'Gorgeous dreamlike artwork on vision cards', traits: ['beautiful', 'creative'] },
    { id: 'mysterium-ghost', label: 'Ghost sends visions without speaking', traits: ['communication-limits', 'creative'] },
    { id: 'mysterium-deduce', label: 'Interpret abstract clues together', traits: ['social-deduction', 'puzzly'] },
  ],
  antiElements: [
    { id: 'mysterium-misalign', label: 'Frustrating when ghost and mediums misalign', traits: ['analysis-paralysis'] },
  ],
}
```
...
```javascript
{
  ...
  complexity: 1.2, bggRating: 7.2,
  traits: ['beautiful', 'creative', 'social', 'light', 'friendly'],
  elements: [
    { id: 'dixit-art', label: 'Stunning surrealist artwork', traits: ['beautiful'] },
    { id: 'dixit-clues', label: 'Give imaginative clues for your card', traits: ['creative', 'social'] },
    { id: 'dixit-social', label: 'Reveals how your friends think', traits: ['social', 'hilarious'] },
    { id: 'dixit-easy', label: 'Anyone can play immediately', traits: ['light', 'friendly'] },
  ],
  antiElements: [
    { id: 'dixit-light', label: 'Not much strategic depth', traits: ['too-random'] },
  ],
}
```
...
```javascript
{
  id: 'memoir-44', name: "Memoir '44", bggId: 10630, year: 2004,
  minPlayers: 2, maxPlayers: 2, minTime: 30, maxTime: 60,
  complexity: 2.3, bggRating: 7.4,
  traits: ['hand-management', 'dice-rolling', 'thematic', 'grid-movement', 'replayable'],
  elements: [
    { id: 'memoir-battles', label: 'WWII tactical battles on hex maps', traits: ['grid-movement', 'strategic', 'thematic'] },
    { id: 'memoir-history', label: 'Historical D-Day scenarios', traits: ['thematic', 'narrative'] },
    { id: 'memoir-gateway', label: 'Entry-level wargame, easy to learn', traits: ['light', 'friendly'] },
    { id: 'memoir-scenarios', label: 'Many historical battles to play', traits: ['replayable', 'thematic'] },
  ],
  antiElements: [
    { id: 'memoir-luck', label: 'Card draw and dice can frustrate', traits: ['too-random'] },
  ],
}
```
...
```javascript
{
  ...
  elements: [
    { id: 'catan-trading', label: 'Negotiate resources with other players', traits: ['trading', 'negotiation', 'social'] },
    { id: 'catan-dice', label: 'Resource production based on dice rolls', traits: ['dice-rolling', 'luck-driven', 'exciting'] },
    { id: 'catan-gateway', label: 'Gateway game classic everyone knows', traits: ['light', 'friendly'] },
    { id: 'catan-build', label: 'Build settlements, roads, and cities', traits: ['route-building', 'satisfying'] },
  ],
  antiElements: [
    { id: 'catan-luck', label: 'Dice luck affects resource flow heavily', traits: ['too-random'] },
    { id: 'catan-kingmaking', label: 'Trading can determine the winner', traits: ['kingmaking'] },
  ],
}
```

### 22. 7 Wonders: Architects
```javascript
{
...
### 30. The Old King's Crown
```javascript
{
  id: 'old-kings-crown', name: "The Old King's Crown", bggId: 357873, year: 2023,
  minPlayers: 1, maxPlayers: 4, minTime: 60, maxTime: 120,
  complexity: 2.7, bggRating: 7.8,
  traits: ['beautiful', 'area-control', 'bluffing', 'thematic', 'solo-mode'],
  elements: [
    { id: 'okc-art', label: 'Stunning fantasy artwork', traits: ['beautiful'] },
    { id: 'okc-hidden', label: 'Secret card placement for intrigue', traits: ['bluffing', 'tense'] },
    { id: 'okc-area', label: 'Claim locations in the kingdom', traits: ['area-control', 'strategic'] },
    { id: 'okc-theme', label: 'Heirs vying for the throne', traits: ['thematic', 'dramatic'] },
  ],
  antiElements: [
    { id: 'okc-ap', label: 'Many options to consider each turn', traits: ['analysis-paralysis'] },
  ],
}
}
```
...
```javascript
{
  ...
  complexity: 2.2, bggRating: 8.0,
  traits: ['card-drafting', 'engine-building', 'strategic', 'elegant', 'tense'],
  elements: [
    { id: '7wd-pyramid', label: 'Draft from pyramid card display', traits: ['card-drafting', 'strategic'] },
    { id: '7wd-engine', label: 'Build resource production chains', traits: ['engine-building', 'satisfying'] },
    { id: '7wd-paths', label: 'Multiple paths to victory', traits: ['strategic', 'replayable'] },
    { id: '7wd-instant', label: 'Military and science can trigger instant wins', traits: ['tense', 'dramatic'] },
  ],
  antiElements: [],
}
```

### 33. Summoner Wars (Second Edition)
```javascript
{
...
```javascript
{
  id: 'cash-n-guns', name: "Cash 'n Guns", bggId: 155362, year: 2014,
  minPlayers: 4, maxPlayers: 8, minTime: 30, maxTime: 30,
  complexity: 1.1, bggRating: 6.9,
  traits: ['bluffing', 'social', 'light', 'exciting', 'hilarious'],
  elements: [
    { id: 'cng-bluff', label: 'Point foam guns at each other, maybe bluffing', traits: ['bluffing', 'tense'] },
    { id: 'cng-standoffs', label: 'Hilarious standoffs and reveals', traits: ['social', 'hilarious', 'dramatic'] },
    { id: 'cng-easy', label: 'Anyone can play immediately', traits: ['light', 'friendly'] },
    { id: 'cng-reveals', label: 'Tense reveals when guns fire', traits: ['exciting', 'dramatic'] },
  ],
  antiElements: [
    { id: 'cng-elimination', label: 'Can get knocked out early', traits: ['player-elimination'] },
  ],
}
```
...
```javascript
{
  ...
  antiElements: [
    { id: 'azul-hate', label: 'Hate-drafting can feel targeted', traits: ['mean-spirited'] },
  ],
}
```
...
```javascript
{
  ...
  elements: [
    { id: 'stella-art', label: "Dixit's gorgeous dreamlike artwork", traits: ['beautiful'] },
...
**Total Games: 44** (from first photo identification)

**Element Categories Used:**
- Mechanics: deckbuilding, worker-placement, area-control, dice-rolling, card-drafting, engine-building, hand-management, hidden-information, simultaneous, tactical, set-collection, push-your-luck, dexterity
- Experience: narrative, thematic, dramatic, tense, exciting, satisfying, relaxing, cozy, beautiful, elegant, humorous, nostalgic
- Social: cooperative, competitive, negotiation, bluffing, communication, social, confrontational, hidden-traitor, asymmetric
- Meta: accessible, replayable, quick, strategic, unique, solo-friendly, family-friendly, educational

**Anti-Elements Used:**
- too-long, too-random, too-light, too-easy
- analysis-paralysis, fiddly, overwhelming, chaotic, unbalanced
- mean-spirited, player-elimination, kingmaking, confrontational
- app-required, one-shot, limited-replayability, frustrating
...
```javascript
{
  ...
  traits: ['strategic', 'thinky', 'beautiful', 'route-building', 'tense', 'satisfying'],
  elements: [
    { id: 'brass-birmingham-economic', label: 'Build industries, manage money, create networks', traits: ['strategic', 'thinky'] },
    { id: 'brass-birmingham-strategic', label: 'Every decision matters enormously', traits: ['strategic'] },
    { id: 'brass-birmingham-beautiful', label: 'Stunning industrial-era artwork', traits: ['beautiful'] },
    { id: 'brass-birmingham-network-buildin', label: 'Connect cities via canals and rails', traits: ['route-building'] },
    { id: 'brass-birmingham-tight', label: 'Resources are scarce, competition fierce', traits: ['tense', 'strategic'] },
    { id: 'brass-birmingham-satisfying', label: 'Building combos feels incredible', traits: ['satisfying'] },
  ],
  antiElements: [
    { id: 'brass-birmingham-anti-analysis-p', label: 'Many interconnected decisions', traits: ['analysis-paralysis'] },
    { id: 'brass-birmingham-anti-punishing', label: 'Mistakes are costly', traits: ['mean-spirited'] },
  ],
}
```

### 46. Star Wars: Rebellion
```javascript
{
...
```javascript
{
  ...
  traits: ['variable-powers', 'beautiful', 'area-control', 'strategic', 'replayable'],
  elements: [
    { id: 'root-factions', label: 'Each faction plays completely differently', traits: ['variable-powers', 'replayable'] },
    { id: 'root-art', label: 'Adorable woodland creature artwork', traits: ['beautiful'] },
    { id: 'root-control', label: 'Control clearings for points', traits: ['area-control', 'strategic'] },
    { id: 'root-interact', label: 'Must engage with other players to win', traits: ['social', 'confrontational'] },
  ],
  antiElements: [
    { id: 'root-learning', label: 'Must learn all factions to play well', traits: ['analysis-paralysis'] },
    { id: 'root-playercount', label: 'Best at 4 players, weaker at 2', traits: ['too-random'] },
  ],
}
```
...
```javascript
{
  ...
  elements: [
    ...
    { id: 'oath-art', label: "Kyle Ferrin's stunning artwork", traits: ['beautiful'] },
  ],
  antiElements: [
...
```javascript
{
  ...
  traits: ['trick-taking', 'dramatic', 'strategic', 'narrative', 'dice-rolling', 'tableau-building'],
  elements: [
    { id: 'arcs-tricks', label: 'Trick-taking card play determines actions', traits: ['trick-taking', 'strategic'] },
    { id: 'arcs-ambitions', label: 'Ambitions create tense dramatic moments', traits: ['dramatic', 'tense'] },
    { id: 'arcs-risk', label: 'Risk vs reward strategic decisions', traits: ['strategic', 'thinky'] },
    { id: 'arcs-court', label: 'Build your tableau of court cards', traits: ['tableau-building', 'engine-building'] },
  ],
  antiElements: [
    { id: 'arcs-chaos', label: 'Hard to plan long-term', traits: ['too-random'] },
    { id: 'arcs-conflict', label: 'Direct conflict is core to the game', traits: ['confrontational'] },
  ],
}
```

### 52. Lost Ruins of Arnak
```javascript
{
  id: 'lost-ruins-of-arnak', name: 'Lost Ruins of Arnak', bggId: 312484, year: 2020,
  minPlayers: 1, maxPlayers: 4, minTime: 60, maxTime: 120,
  complexity: 2.9, bggRating: 8.0,
  traits: ['deck-building', 'worker-placement', 'thematic', 'beautiful', 'solo-mode'],
  elements: [
    { id: 'arnak-hybrid', label: 'Deck-building meets worker placement', traits: ['deck-building', 'worker-placement'] },
    { id: 'arnak-explore', label: 'Explore ancient ruins for artifacts', traits: ['thematic', 'exciting'] },
    { id: 'arnak-art', label: 'Beautiful adventure artwork', traits: ['beautiful'] },
    { id: 'arnak-research', label: 'Research track for bonuses', traits: ['strategic', 'satisfying'] },
  ],
  antiElements: [
    { id: 'arnak-multi', label: 'Can feel like multiplayer solitaire', traits: ['too-random'] },
  ],
}
```

### 53. SETI: Search for Extraterrestrial Intelligence
```javascript
{
  ...
  traits: ['thematic', 'hand-management', 'engine-building', 'beautiful', 'strategic', 'exciting'],
  elements: [
    { id: 'seti-thematic', label: 'Real space projects on cards', traits: ['thematic'] },
    { id: 'seti-hand-management', label: 'Multi-use cards', traits: ['hand-management'] },
    { id: 'seti-engine-building', label: 'Tech upgrades and combos', traits: ['engine-building'] },
    { id: 'seti-beautiful', label: 'Rotating solar system board', traits: ['beautiful'] },
    { id: 'seti-strategic', label: 'Deep decision space', traits: ['strategic'] },
    { id: 'seti-exciting', label: 'Discovering alien life!', traits: ['exciting'] },
  ],
  antiElements: [
    { id: 'seti-anti-analysis-p', label: 'Overwhelming options', traits: ['analysis-paralysis'] },
    { id: 'seti-anti-too-long', label: 'Can run long', traits: ['too-long'] },
  ],
}
```
...
### 55. Tales of the Arabian Nights
```javascript
{
...
### 61. Lord of the Rings: The Card Game
```javascript
{
...
### 63. Deception: Murder in Hong Kong
```javascript
{
...
```javascript
{
  ...
  traits: ['puzzly', 'elegant', 'light', 'strategic', 'relaxing'],
  elements: [
    { id: 'patchwork-puzzle-solving', label: 'Tetris-like fitting', traits: ['puzzly'] },
    { id: 'patchwork-elegant', label: 'Simple rules, deep play', traits: ['elegant'] },
    { id: 'patchwork-quick', label: 'Fast games', traits: ['light'] },
    { id: 'patchwork-strategic', label: 'Time track decisions matter', traits: ['strategic'] },
    { id: 'patchwork-relaxing', label: 'Cozy quilt theme', traits: ['relaxing'] },
  ],
  antiElements: [
...
### 77. Stardew Valley: The Board Game
```javascript
{
...
### 85. Sherlock Holmes: Consulting Detective
```javascript
{
...
### 86. A Game of Thrones: The Card Game
```javascript
{
...
### 90. The Crew: Quest for Planet Nine
```javascript
{
  ...
  traits: ['cooperative', 'trick-taking', 'communication-limits', 'elegant', 'campaign', 'thematic'],
  elements: [
    { id: 'the-crew-cooperative', label: 'Win tricks together', traits: ['cooperative'] },
    { id: 'the-crew-trick-taking', label: 'Classic card mechanism', traits: ['trick-taking'] },
    { id: 'the-crew-communication', label: 'Limited info sharing', traits: ['communication-limits'] },
    { id: 'the-crew-elegant', label: 'Simple, brilliant', traits: ['elegant'] },
    { id: 'the-crew-campaign', label: '50 missions', traits: ['campaign'] },
    { id: 'the-crew-challenging', label: 'Gets genuinely hard', traits: ['thematic'] },
  ],
  antiElements: [
...
```javascript
{
  ...
  traits: ['card-drafting', 'strategic', 'thematic', 'variable-powers', 'satisfying'],
  elements: [
    { id: 'ark-nova-card-drafting', label: 'Animals and sponsors to acquire', traits: ['card-drafting'] },
    { id: 'ark-nova-strategic', label: 'Deep interlocking systems', traits: ['strategic'] },
    { id: 'ark-nova-thematic', label: 'Zoo building with conservation', traits: ['thematic'] },
    { id: 'ark-nova-variable-powers', label: 'Action card strength varies', traits: ['variable-powers'] },
    { id: 'ark-nova-satisfying', label: 'Building combos feels great', traits: ['satisfying'] },
  ],
  antiElements: [
    { id: 'ark-nova-anti-too-long', label: 'Can run 3+ hours', traits: ['too-long'] },
    { id: 'ark-nova-anti-analysis-p', label: 'Many options each turn', traits: ['analysis-paralysis'] },
  ],
}
```
...
```javascript
{
  ...
  complexity: 3.4, bggRating: 8.2,
  traits: ['engine-building', 'beautiful', 'area-control', 'variable-powers', 'strategic', 'thematic'],
  elements: [
    { id: 'scythe-engine-building', label: 'Upgrade actions, deploy mechs', traits: ['engine-building'] },
    { id: 'scythe-beautiful', label: 'Stunning dieselpunk art', traits: ['beautiful'] },
    { id: 'scythe-area-control', label: 'Control territories', traits: ['area-control'] },
    { id: 'scythe-asymmetric', label: 'Each faction plays differently', traits: ['variable-powers'] },
    { id: 'scythe-strategic', label: 'Many paths to victory', traits: ['strategic'] },
    { id: 'scythe-thematic', label: 'Alternate history 1920s', traits: ['thematic'] },
  ],
  antiElements: [
    { id: 'scythe-anti-misleading', label: 'Less combat than it looks', traits: ['too-random'] },
    { id: 'scythe-anti-analysis-p', label: 'Many options', traits: ['analysis-paralysis'] },
  ],
}
```
...
```javascript
{
  ...
  complexity: 2.8, bggRating: 8.0,
  traits: ['beautiful', 'engine-building', 'worker-placement', 'tableau-building', 'thematic'],
  elements: [
    { id: 'everdell-beautiful', label: 'Gorgeous woodland art and 3D tree', traits: ['beautiful'] },
    { id: 'everdell-engine-building', label: 'Build your city of critters', traits: ['engine-building'] },
    { id: 'everdell-worker-placemen', label: 'Place workers for resources', traits: ['worker-placement'] },
    { id: 'everdell-tableau-buildin', label: 'Create your city tableau', traits: ['tableau-building'] },
    { id: 'everdell-thematic', label: 'Charming woodland theme', traits: ['thematic'] },
  ],
  antiElements: [
    { id: 'everdell-anti-too-random', label: 'Card draw luck', traits: ['too-random'] },
  ],
}
```
...
```javascript
{
  ...
  complexity: 1.9, bggRating: 8.1,
  traits: ['beautiful', 'puzzly', 'relaxing', 'light', 'friendly', 'elegant'],
  elements: [
    { id: 'cascadia-beautiful', label: 'Pacific Northwest nature art', traits: ['beautiful'] },
    { id: 'cascadia-puzzle-solving', label: 'Tile and token placement', traits: ['puzzly'] },
    { id: 'cascadia-relaxing', label: 'Peaceful gameplay', traits: ['relaxing'] },
    { id: 'cascadia-accessible', label: 'Easy to teach', traits: ['light', 'friendly'] },
    { id: 'cascadia-elegant', label: 'Simple rules, satisfying decisions', traits: ['elegant'] },
  ],
  antiElements: [
...
### 125. Survive: Escape from Atlantis
```javascript
{
...
```javascript
{
  ...
  traits: ['engine-building', 'elegant', 'light', 'friendly', 'strategic', 'grid-movement', 'beautiful'],
  elements: [
    { id: 'splendor-engine-building', label: 'Gems make gems cheaper', traits: ['engine-building'] },
    { id: 'splendor-elegant', label: 'Simple, satisfying', traits: ['elegant'] },
    { id: 'splendor-accessible', label: 'Great gateway', traits: ['light', 'friendly'] },
    { id: 'splendor-tactical', label: 'Watch what opponents take', traits: ['strategic', 'grid-movement'] },
    { id: 'splendor-beautiful', label: 'Chunky gem chips', traits: ['beautiful'] },
  ],
  antiElements: [
...
### 138. Horizon Zero Dawn: The Board Game
```javascript
{
...
### 146. Pathfinder Adventure Card Game
```javascript
{
...
### 151. Flick 'em Up: Dead of Winter
```javascript
{
...
# PHOTO 5 GAMES (Nostalgia Collection)
...
This document contains full element decomposition for 175 board games from the user's collection, ready for integration into the Board Game Recommender V7.

**Element Vocabulary Used (85+ unique elements):**
- Core mechanics: deckbuilding, worker-placement, area-control, dice-rolling, card-drafting, engine-building, hand-management, hidden-information, trick-taking, set-collection, push-your-luck, tableau-building, network-building, trading, bidding, climbing, tile-laying, roll-and-write, racing, hidden-movement
- Dexterity/Physical: dexterity, drawing, tactile
- Time mechanisms: real-time, simultaneous
- Experience: narrative, thematic, dramatic, tense, exciting, satisfying, relaxing, cozy, beautiful, elegant, humorous, nostalgic, creative, educational, challenging, difficult, colorful, chaotic
- Social: cooperative, competitive, negotiation, bluffing, communication, social, confrontational, hidden-traitor, semi-cooperative, asymmetric, take-that, team-based, party, betting
- Meta: accessible, replayable, quick, strategic, unique, solo-friendly, solo-only, family-friendly, portable, campaign, legacy, scenarios, scalable-difficulty, customizable, miniatures

**Anti-Element Vocabulary (35+ unique):**
- too-long, too-random, too-light, too-easy, too-hard
- analysis-paralysis, fiddly, overwhelming, chaotic, unbalanced, punishing, restrictive, brain-burn, misleading
- mean-spirited, player-elimination, kingmaking, confrontational, stressful, physical-demand
- app-required, one-shot, limited-replayability, expensive, limited
- requires-group, requires-lying, requires-creativity, requires-improv, requires-drawing
- learning-cliff, imbalanced-at-low-counts, no-strategy, dated, out-of-print, setup-time, vocabulary-dependent
...
Copy this prompt to Claude CLI along with this document:

```
Read the attached games-data-for-recommender.md file. It contains 175 board games with full element decomposition.

Your task:
1. Parse all 175 game objects from the markdown code blocks
2. Add them to the GAMES array in board-game-recommender-v7.jsx
3. For any NEW elements not already in the ELEMENTS object, add them with appropriate descriptions
4. Maintain the existing data structure format exactly

Important notes:
- Each game has: id, name, bggId, bggRating, complexity, players, time, year, elements[], antiElements[]
- Elements have: name, sentiment ('positive'), note
- AntiElements have: name, note
- Some games may already exist in the GAMES array - skip duplicates
- The V7 file uses localStorage for ratings - don't change that functionality

After adding, verify the app still runs and displays all games correctly.
```

### New Elements to Define

These elements appear in the games but may not be in the existing ELEMENTS object. Add descriptions like:

```javascript
// New positive elements
'economic': { description: 'Money management and market dynamics', icon: '💰' },
'network-building': { description: 'Creating connections between locations', icon: '🔗' },
'tight': { description: 'Resources are scarce, every decision matters', icon: '🎯' },
'cat-and-mouse': { description: 'One side hunts while the other hides', icon: '🐱' },
'semi-cooperative': { description: 'Work together but with hidden agendas', icon: '🤝' },
'legacy-lite': { description: 'Persistent changes without permanent destruction', icon: '📜' },
'political': { description: 'Alliances, voting, and power struggles', icon: '🏛️' },
'dice-crafting': { description: 'Physically modify your dice', icon: '🎲' },
'word-game': { description: 'Spelling or vocabulary-based', icon: '📝' },
'trivia': { description: 'Knowledge-based questions', icon: '❓' },
'betting': { description: 'Wagering on outcomes', icon: '🎰' },
'climbing': { description: 'Play higher cards to win tricks', icon: '📈' },
'tactile': { description: 'Satisfying physical components', icon: '✋' },
'portable': { description: 'Small box, easy to travel with', icon: '🎒' },
'customizable': { description: 'Build or modify game components', icon: '🔧' },
'miniatures': { description: 'Features detailed miniature figures', icon: '🗿' },
'hidden-movement': { description: 'One player moves secretly', icon: '👻' },
'racing': { description: 'First to finish wins', icon: '🏎️' },

// New anti-elements
'dated': { description: 'Rules or design feel old-fashioned' },
'out-of-print': { description: 'Hard to find or expensive' },
'setup-time': { description: 'Takes a while to set up' },
'vocabulary-dependent': { description: 'Advantages players with large vocabularies' },
'misleading': { description: 'Game is different than it appears' },
'limited': { description: 'Not much depth or replayability' },
'physical-demand': { description: 'Requires physical flexibility or ability' },
```
...
- [ ] All 175 games appear in the game list
- [ ] Filtering by elements works
- [ ] Search finds games by name
- [ ] Rating/swiping still works
- [ ] localStorage persists ratings
- [ ] New elements appear in filter options

### File Locations

- **Source data**: games-data-for-recommender.md (this file)
- **Target file**: board-game-recommender-v7.jsx
- **Deploy guide**: board-game-recommender-deploy-guide.md
